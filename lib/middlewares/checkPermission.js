...
class CheckPermissionsMw {
    constructor(db, redisClient) {
        this.handler = (requestedPermissions) => (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            while (i < requestedPermissions.length) {
                allowed = yield this.isPermissionAllowed(requestedPermissions[i], req.currentUser.role_id, req.currentUser.user_id, req.currentUser.delegateeId);
    ...
    isPermissionAllowed(permission, roleId, userId, delegateeId) {
